          ...
          <div class="item-info">
            ...
            <div style="width: 100%;">
              ...
              <ul class="item-btn-wrapper">
                <li v-if="item.rakuten_url !== null"><a :href="item.rakuten_url" class="item-link" target="_blank" rel="noopener">楽天で詳細をみる</a></li>
                <li v-if="item.amazon_url !== null"><a :href="item.amazon_url" class="item-link" target="_blank" rel="noopener">Amazonで詳細をみる</a></li>
              </ul>
            </div>
          </div>
        </li>
